	...
	function weblizar_default_settings()
{
	...
	$wl_theme_options=array(
			...
			'slide_btn_link_3' => '#',
            'slide_image_4' => $ImageUrl3,
            'slide_title_4' => __('Contrary to popular ', 'weblizar' ),
            ...
            'slide_btn_link_4' => '#',
            'slide_image_5' => $ImageUrl3,
            'slide_title_5' => __('Contrary to popular ', 'weblizar' ),
            'slide_desc_5' => __('Aldus PageMaker including versions of Lorem Ipsum, rutrum turpi', 'weblizar' ),
            'slide_btn_text_5' => __('Read More', 'weblizar' ),
            'slide_btn_link_5' => '#',  
